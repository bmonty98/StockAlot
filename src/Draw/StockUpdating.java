...
public class StockUpdating implements Runnable {
    ...
    public void run() {
        try {
            ...
            e.printStackTrace();
            this.run(); 
            // When exception happens, it's because the portfolio is being edited at the same time in multiple threads
            // Solution is evident, sleep this thread when thread is bought / sold
